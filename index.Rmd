...
```{r, echo = FALSE, code = readLines("Chart1TylerRamos.R"), warning = FALSE}
...
```{r, echo = FALSE, code = readLines("Chart2TylerRamos.R"), warning = FALSE}
...
```{r, echo = FALSE, code = readLines("Chart3TylerRamos.R"), warning = FALSE}
